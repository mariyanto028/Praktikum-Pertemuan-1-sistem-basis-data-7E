...
-- Dumping data for table presensi_penggajihan.bagian: ~3 rows (approximately)
...
-- Dumping data for table presensi_penggajihan.bagian_karyawan: ~6 rows (approximately)
...
-- Dumping data for table presensi_penggajihan.jabatan: ~10 rows (approximately)
...
REPLACE INTO `jabatan` (`id`, `nama_jabatan`, `gapok_jabatan`, `tunjangan_jabatan`, `uang_makan_perhari`) VALUES
	...
	(11, 'Untuk Coba Hapus', 999, 999, 999);
/*!40000 ALTER TABLE `jabatan` ENABLE KEYS */;

-- Dumping data for table presensi_penggajihan.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping data for table presensi_penggajihan.karyawan: ~8 rows (approximately)
...
-- Dumping data for table presensi_penggajihan.lokasi: ~3 rows (approximately)
...
-- Dumping data for table presensi_penggajihan.penggajian: ~36 rows (approximately)
...
REPLACE INTO `penggajian` (`id`, `karyawan_id`, `tahun`, `bulan`, `gapok`, `tunjangan`, `uang_makan`) VALUES
	...
	(19, 3, '2020', '11', 2400000, 500000, 800000),
	(20, 4, '2020', '11', 2300000, 450000, 684000),
	(21, 5, '2020', '11', 2200000, 400000, 684000),
	(22, 6, '2020', '11', 2100000, 350000, 640000),
	(23, 7, '2020', '11', 2100000, 350000, 612000),
	(24, 8, '2020', '11', 1000000, 100000, 380000),
	(25, 3, '2020', '12', 2400000, 500000, 800000),
	(26, 4, '2020', '12', 2300000, 450000, 722000),
	(27, 5, '2020', '12', 2200000, 400000, 720000),
	(28, 6, '2020', '12', 2100000, 350000, 680000),
	(29, 7, '2020', '12', 2100000, 350000, 646000),
	(30, 8, '2020', '12', 1000000, 100000, 360000),
	(31, 3, '2021', '01', 2400000, 500000, 800000),
	(32, 4, '2021', '01', 2300000, 450000, 722000),
	(33, 5, '2021', '01', 2200000, 400000, 612000),
	(34, 6, '2021', '01', 2100000, 350000, 680000),
	(35, 7, '2021', '01', 2100000, 350000, 646000),
	(36, 8, '2021', '01', 1000000, 100000, 340000);
/*!40000 ALTER TABLE `penggajian` ENABLE KEYS */;

-- Dumping data for table presensi_penggajihan.pengguna: ~8 rows (approximately)
...
-- Dumping data for table presensi_penggajihan.presensi: ~552 rows (approximately)
